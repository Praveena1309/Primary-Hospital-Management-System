...
urlpatterns = [
    ...
    # path('update-pharmacy-status/', views.update_pharmacy_status,name='update-pharmacy-status'),
    # path('update-status/<int:pk>/', views.update_status, name='update-status'),
    path('update_pharmacy_status/<int:pk>/', views.update_prescription_status, name='update_pharmacy_status'),
    ...
    path('pharmacist-history/', views.pharmacist_history,name='pharmacist-history'),
    path('prescription_view_admin/<int:pk>', views.prescription_view_admin, name='prescription_view_admin'),
