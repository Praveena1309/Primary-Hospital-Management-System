...
class Hospital_Information(models.Model):
    ...
    general_bed_no = models.BigIntegerField(null=True, blank=True)
    available_icu_no = models.BigIntegerField(null=True, blank=True)
    regular_cabin_no = models.BigIntegerField(null=True, blank=True)
    emergency_cabin_no = models.BigIntegerField(null=True, blank=True)
    vip_cabin_no = models.BigIntegerField(null=True, blank=True)
